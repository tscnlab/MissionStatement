...
The following is a collection of principles that we follow in our research group. The statement contains values and expectations that were initially derived from discussions at the 2022 lab retreat at the TUM Akademiezentrum Raitenhaslach and updated at the 2023 lab retreat in Owingen, the 2024 lab retreat at Schneefernerhaus (Zugspitze), and the 2026 lab retreat in Milan on 10 September 2026. It is a living document.

### Version history

Current version/date: v1.5 | 10 September 2026
...
One way we give back to society is by engaging with the public through a variety of means, such as giving public talks, participating in and organizing science outreach events, developing educational resources, [comic books](https://enlightenyourclock.org/), [podcasts](https://tscnlab.org/podcast), and giving interviews. Our [“Nachtmensch oder Frühaufsteher?” roadshow](https://nachtmensch-oder-fruehaufsteher.de/) brings research on light and our internal clocks to the public through interactive experiments and direct dialogue with scientists. We seek and create opportunities for the application and translation of our work (such as through the [Ladenburg White Paper](https://doi.org/10.17605/osf.io/rxa35)).
...
We acknowledge that working in academia poses threats to well-being and work-life balance, and that our lab has faced challenges in these areas throughout its lifetime. **Recognising and acknowledging these challenges is the crucial first step** towards addressing them. We encourage open conversations about workload, stress and support needs, and work together to identify problems and make practical changes.

We are committed to our work without losing sight of our well-being. Accordingly, we value a **healthy work-life balance**. Employees are allowed to design their own working schedule and can work from home by arrangement. We support **chronotype-friendly working arrangements** that recognise individual differences in sleep and activity timing. We take these differences into account when scheduling meetings and shared activities, alongside research and team needs.

During holiday time, employees are not expected to be involved in work-related matters, including responding to emails and messages. Our team is encouraged to engage in **self-care and hobbies** in their free time. Moreover, stress-reducing activities, such as yoga, meditation, and/or exercise, are supported during working hours. We encourage people to take sick leave when necessary, including for mental health issues and to protect each other. We actively participate in team events, such as health days and fun runs.
...
We are committed to pursuing and advancing open scholarship in research and teaching. This concerns the whole scientific process, including **preregistration** and **publishing**. Our goal is to make science **transparent and accessible**, not only to fellow scientists but extending to students and the general public. We prioritise publishing our scientific publications in **open-access** outlets. We put open science into practice by maintaining **public GitHub repositories** for our research projects, with version-controlled analysis scripts, documentation and instructions for reuse. We share **documented datasets and data releases** as research outputs in their own right, including releases that are not tied to individual publications, through suitable repositories.

We encourage and support **replication attempts** of our results. We recognise that replication requires time, effort and funding, and take these resource needs into account when planning replication work and responding to requests for support. We engage with external requests for sharing materials, code and data and discuss the support we can provide.

We strive to work in an **open-source ecosystem**. This means using preferably non-proprietary, open-source software. Importantly, benefitting from other’s open source software, we also see responsibility in contributing to the software development process to our ability (e.g. reporting issues).
...
Our mission is to perform **robust and reproducible research**. We achieve this goal through various actions, including documentation of program code and analysis steps, preregistration of experiments, internal replication, and data and code reviews. We establish naming conventions for files and we write standard operating procedures (SOPs) for experiments, data collection and -management, data storage and for analysis. Where appropriate, we arrange independent computational reproducibility checks, such as [CODECHECK](https://codecheck.org.uk/), to document whether others can execute our code using the supplied data and instructions and reproduce the computational outputs.
...
We commit to sustainability and sustainable research practices built on **conscious and intentional use of resources**, reducing consumption and reusing what we have. This includes **reducing CO<sub>2</sub> emissions, reducing waste (paper, food, plastic, ...) and reusing resources**. We consider whether a resource is needed, whether it can be shared or reused, and the environmental impact of our choices. We achieve this by a variety of means:

We aim to share instruments and repair old instruments instead of buying new devices. We encourage reducing (paper, plastic) waste and ask our institutions to switch to digital forms. We aim to make our code efficient and test it, use sustainable computing practices, and share code and data. We integrate sustainability and sustainable research practices into our teaching and consider opportunities to address sustainability-related questions within our field.
